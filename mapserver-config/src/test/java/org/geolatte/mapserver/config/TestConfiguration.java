...
//        Configuration.ResourceType expected = Configuration.ResourceType.URL;
//        assertEquals(expected, config.getType("basic"));
//
//        expected = Configuration.ResourceType.FILE;
...
//        String expected = "org.geolatte.mapserver.wms_1_3_0.DefaultBoundingBoxOpFactory";
