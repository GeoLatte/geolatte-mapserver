...
//            LOGGER.warn(String.format("Failed to instantiate TILE_MAP \"%s\": %s", tileMapName, e.getMessage()));
//        }
//    }
//
...
//            LOGGER.warn(String.format("Failed to register additional SRS's for TILE_MAP \"%s\": %s", tileMapName, e.getMessage()));
//        }
//        return result;
//    }
//
...
//            return builder.build(getTileImageSourceFactory(sourceFactoryName), getBoundingBoxOpFactory(boundingBoxOpFactoryName), forceArgb);
//        else
//            return builder.build(getTileImageSourceFactory(sourceFactoryName), forceArgb);
//    }
//
...
//
//    /**
//     * Lists the SRS to which the images of the specified <code>TILE_MAP</code> can be projected.
//     *
//     * @param tileMapName the <code>TILE_MAP</code> name
//     * @return a list of <code>SRS</code>s to which projection is supported.
//     */
//    //TODO Does this need to move to TILE_MAP?
...
//
//    /**
//     * Checks whether the <code>TILE_MAP</code> can be
//     * projected to the target <code>SRS</code> are supported
//     *
//     * @param tileMapName the <code>TILE_MAP</code> name
//     * @param srs         the target <code>SRS</code>
//     * @return returns true if the <code>TILE_MAP</code> supports the <code>SRS</code>.
//     */
