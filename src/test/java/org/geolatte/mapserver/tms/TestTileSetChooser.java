...
public class TestTileSetChooser {
    ...
    static {
        ...
        tileMap = tileMapBuilder.buildTileMap();
    }
    ...
    public void test_determine_request_UnitsPerPixel_squarebox() {
        ...
        //order 0
        Envelope bbox = new Envelope(Point.create2D(-180, -90, CrsId.UNDEFINED.getCode()), Point.create2D(0, 90, CrsId.UNDEFINED.getCode()), null);
        ...
        //order 1
        bbox = new Envelope(Point.create2D(-45, 0, CrsId.UNDEFINED.getCode()), Point.create2D(45, 90,  CrsId.UNDEFINED.getCode()), null);
        tsc = new TileSetChooser(tileMap, bbox, dim);
        tsc.determineRequestUnitsPerPixel();
        upp = (Double) TMSTestSupport.accessField(tsc, "requestUnitsPerPixel");
    ...
    public void test_determine_request_UnitsPerPixel_aspectratio_difference() {
        ...
        //order 0
        Envelope bbox = new Envelope(Point.create2D(-180, -90, CrsId.UNDEFINED.getCode()), Point.create2D(0, 0, CrsId.UNDEFINED.getCode()), null);
        Dimension dim = new Dimension(256, 256);
        tsc = new TileSetChooser(tileMap, bbox, dim);
        tsc.determineRequestUnitsPerPixel();
        upp = (Double) TMSTestSupport.accessField(tsc, "requestUnitsPerPixel");
